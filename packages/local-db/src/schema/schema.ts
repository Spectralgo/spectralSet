...
export const worktrees = sqliteTable(
	"worktrees",
	{
		...
		// Track whether this worktree was created by SpectralSet or imported from external source
		// Used to prevent accidental deletion of user-created worktrees
		createdBySpectralset: integer("created_by_spectralset", { mode: "boolean" })
			.notNull()
			.default(true),
	},
	(table) => [
