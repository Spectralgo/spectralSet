...
// =============================================================================
// @spectralset/local-db Schema Mock (drizzle-orm/sqlite-core not available in Bun tests)
// =============================================================================
...
mock.module("@spectralset/local-db", localDbMock);
mock.module("@spectralset/local-db/schema", localDbMock);
