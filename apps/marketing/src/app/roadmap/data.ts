...
export const ROADMAP_ITEMS: RoadmapItem[] = [
	...
	// ── Next ─────────────────────────────────────────
	{
		...
		description:
			"Launch and manage SpectralSet agents directly from the VS Code sidebar.",
	...
	// ── Later ────────────────────────────────────────
	{
		...
		description:
			"Run SpectralSet on your own infrastructure with a single Docker Compose file.",
		category: "Web",
		status: "later",
	},
	{
	...
	},
	{
		...
		description:
			"Full SpectralSet integration for IntelliJ, WebStorm, and other JetBrains IDEs.",
		category: "Integrations",
		status: "later",
	},
