...
1. `react-mosaic`
2. `FlexLayout`
3. Our proposed SpectralSet pane-layout implementation
...
That is the model I would treat as “correct” for SpectralSet, even where it diverges from both reference libraries.
