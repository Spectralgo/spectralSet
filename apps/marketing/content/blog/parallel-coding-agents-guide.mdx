...
Tools like [SpectralSet](https://spectralset.dev) handle orchestration end-to-end:
...
1. **Pick an orchestrator** — [SpectralSet](https://spectralset.dev) handles worktrees, sessions, and review
