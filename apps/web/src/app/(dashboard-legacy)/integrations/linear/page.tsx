			...
			<div className="flex items-start gap-6">
				...
				<div className="flex-1">
					...
					<p className="mt-1 text-muted-foreground">
						Sync issues bidirectionally with Linear. Create tasks in SpectralSet
			...
			{connection && (
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Configure how tasks sync between SpectralSet and Linear.
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="space-y-2">
							...
							<p className="text-sm text-muted-foreground">
								Tasks created in SpectralSet will be synced to this Linear team.
							</p>
						</div>
					</CardContent>
				</Card>
