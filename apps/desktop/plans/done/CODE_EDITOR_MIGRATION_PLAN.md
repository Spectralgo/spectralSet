...
- basic find support
- theme application using existing SpectralSet theme tokens
...
- map SpectralSet theme tokens to a shared editor theme contract
...
2. Should find be implemented with native CodeMirror search UI, or should it continue to route through SpectralSet-owned UI controls?
