 ...
 *   SPECTRALSET_DEBUG=1 bun run desktop
 *
 * Or in .env:
 *   SPECTRALSET_DEBUG=1
 *
...
const isDebugEnabled =
	...
	(process.env.SPECTRALSET_DEBUG === "1" ||
		process.env.SPECTRALSET_DEBUG === "true");

/**
 * Log a debug message if SPECTRALSET_DEBUG is enabled.
 *
