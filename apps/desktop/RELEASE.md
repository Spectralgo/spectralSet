...
- **macOS manifest**: `https://github.com/Spectralgo/spectralSet/releases/latest/download/latest-mac.yml`
- **Linux manifest**: `https://github.com/Spectralgo/spectralSet/releases/latest/download/latest-linux.yml`
- **macOS installer**: `https://github.com/Spectralgo/spectralSet/releases/latest/download/SpectralSet-arm64.dmg`
- **Linux installer**: `https://github.com/Spectralgo/spectralSet/releases/latest/download/SpectralSet-x64.AppImage`
