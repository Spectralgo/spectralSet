...
<YouTubeVideo id="8PuptrsyNvM" title="SpectralSet Workspaces" thumbnail="/images/branches.png" />
...
If you have existing git worktrees on disk, use the **Import** tab in the New Workspace modal to bring them into SpectralSet. Click **Import all** to bulk-import all discovered worktrees at once.
