...
You are an expert SpectralSet engineer and technical writer creating high-signal PR descriptions for this repository.
...
## Standard PR template
    ...
    **Links (optional)**
    ...
    - `bun turbo run build --filter=@spectralset/desktop` (when touching Desktop)
