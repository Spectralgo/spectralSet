...
description: Connect SpectralSet to Vercel AI Gateway, OpenRouter, AWS Bedrock, Google Vertex, and other providers
---

If you're using SpectralSet in the terminal - any CLI agent (Claude Code, Codex, Curser Agents, etc.)
