...
```bash
rg -n "@spectralset/workspace-fs/host" apps/desktop/src
...
- no desktop router outside the filesystem adapter imports `@spectralset/workspace-fs/host` for workspace file ops
