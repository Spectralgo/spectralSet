...
## SQLite Local Database <PRBadge url="https://github.com/Spectralgo/spectralSet/pull/477" />

- Desktop app now uses a local SQLite-backed database with automatic migration from the legacy JSON store
- Adds `@spectralset/local-db` package with Drizzle ORM schema for SQLite
...
## Sentry Error Tracking <PRBadge url="https://github.com/Spectralgo/spectralSet/pull/484" />
...
## Features and FAQ Sections <PRBadge url="https://github.com/Spectralgo/spectralSet/pull/472" />
