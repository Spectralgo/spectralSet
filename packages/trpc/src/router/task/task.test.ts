...
mock.module("@spectralset/db/client", () => ({
	db: {
...
mock.module("@spectralset/db/schema", () => ({
	members: {
...
mock.module("@spectralset/db/seed-default-statuses", () => ({
	seedDefaultStatuses: seedDefaultStatusesMock,
}));

mock.module("@spectralset/db/utils", () => ({
	getCurrentTxid: getCurrentTxidMock,
}));

mock.module("@spectralset/shared/task-slug", () => ({
