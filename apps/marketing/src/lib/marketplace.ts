...
export const themeListings: ThemeListing[] = [
	{
		...
		submittedBy: "tkcel",
		description:
			"A GitHub-inspired dark theme adapted for SpectralSet with strong blue, amber, and green contrast.",
	...
	},
	{
		...
		description:
			"The Mocha variant from the Catppuccin theme PR for SpectralSet.",
	...
	},
	{
		...
		submittedBy: "tamarazuk",
		description:
			"The Macchiato variant from the Catppuccin theme PR for SpectralSet.",
		addedOn: "March 21, 2026",
		source: {
			label: "Download",
	...
	},
	{
		...
		submittedBy: "tamarazuk",
		description:
			"The Frappé variant from the Catppuccin theme PR for SpectralSet.",
		addedOn: "March 21, 2026",
		source: {
			label: "Download",
	...
	},
	{
		...
		submittedBy: "tamarazuk",
		description:
			"The Latte variant from the Catppuccin theme PR for SpectralSet.",
		addedOn: "March 21, 2026",
		source: {
			label: "Download",
