...
7. **Teardown never runs for cloud-originated deletes.** Any `SPECTRALSET_WORKSPACE_NAME`-dependent cleanup scripts silently skip when users delete via the v2 sidebar.
